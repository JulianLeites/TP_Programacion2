...
productos.filter(prod => prod.categoria === "Calzado").forEach(prod =>{      //recorre todos los productos de la categoria
...
document.querySelectorAll(".agregar").forEach(agregar => {
    ...
    agregar.addEventListener('click', () => {
        ...
        if (nombresProductos.includes(nombre)) {
            ...
            // Actualizar la cantidad del producto en el localStorage
